...
public class FieldParser {
	...
	private static final ReturnTypeAdapter<?, Optional<Component>>[] ERROR_TYPE_ADAPTERS = new ReturnTypeAdapter[]{
	  ...
	  ReturnTypeAdapter.of(EntryType.of(String.class), t -> Optional.ofNullable(t).map(Component::translatable)),
	  ReturnTypeAdapter.of(EntryType.of(boolean.class), t -> t? Optional.of(Component.translatable("simpleconfig.config.error.invalid_value_generic")) : Optional.empty())
	};
