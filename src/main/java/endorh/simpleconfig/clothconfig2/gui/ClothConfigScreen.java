...
import endorh.simpleconfig.clothconfig2.gui.widget.SearchBarWidget.ISearchHandler;
		...
		public EditConfigFileDialog(
		  ClothConfigScreen screen, Path file
			...
			super(screen, new TranslationTextComponent(
			  "simpleconfig.file.dialog.title"
			), b -> {
				if (b) open(file);
			}, splitTtc(
