...
public class StringListBuilder
  extends FieldBuilder<List<String>, StringListListEntry> {
	...
	private Function<List<String>, Optional<ITextComponent[]>> tooltipSupplier =
	  list -> Optional.empty();
	...
	public StringListBuilder(
	  ITextComponent resetButtonKey, ITextComponent fieldNameKey, List<String> value
	) {
	...
	public StringListBuilder setCellErrorSupplier(
	  Function<String, Optional<ITextComponent>> cellErrorSupplier
	) {
		this.cellErrorSupplier = cellErrorSupplier;
		return this;
	}
	
	public StringListBuilder setErrorSupplier(
	  Function<List<String>, Optional<ITextComponent>> errorSupplier
	) {
	...
	public StringListBuilder setCreateNewInstance(
	  Function<StringListListEntry, StringListListEntry.StringListCell> createNewInstance
	) {
	...
	public StringListBuilder setTooltipSupplier(
	...
	public StringListBuilder setTooltipSupplier(
	  Function<List<String>, Optional<ITextComponent[]>> tooltipSupplier
	) {
	...
	public StringListListEntry build() {
		StringListListEntry entry =
		  new StringListListEntry(this.getFieldNameKey(), this.value, this.expanded, null,
