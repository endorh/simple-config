...
public class LongListBuilder
  extends FieldBuilder<List<Long>, LongListListEntry> {
	protected Function<Long, Optional<ITextComponent>> cellErrorSupplier;
	private Consumer<List<Long>> saveConsumer = null;
	private Function<List<Long>, Optional<ITextComponent[]>> tooltipSupplier =
	  list -> Optional.empty();
	...
	public LongListBuilder(
	  ITextComponent resetButtonKey, ITextComponent fieldNameKey, List<Long> value
	) {
	...
	public LongListBuilder setCellErrorSupplier(
	  Function<Long, Optional<ITextComponent>> cellErrorSupplier
	) {
		this.cellErrorSupplier = cellErrorSupplier;
		return this;
	}
	
	public LongListBuilder setErrorSupplier(
	  Function<List<Long>, Optional<ITextComponent>> errorSupplier
	) {
	...
	public LongListBuilder setCreateNewInstance(
	  Function<LongListListEntry, LongListListEntry.LongListCell> createNewInstance
	) {
	...
	public LongListBuilder setTooltipSupplier(
	  Function<List<Long>, Optional<ITextComponent[]>> tooltipSupplier
	) {
	...
	public LongListListEntry build() {
		LongListListEntry entry =
		  new LongListListEntry(this.getFieldNameKey(), this.value, this.expanded, null,
