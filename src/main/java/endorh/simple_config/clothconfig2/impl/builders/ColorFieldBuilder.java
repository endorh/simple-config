...
public class ColorFieldBuilder extends FieldBuilder<String, ColorEntry> {
   ...
   private Function<Integer, Optional<ITextComponent[]>> tooltipSupplier = (str) -> {
   ...
   public ColorFieldBuilder setSaveConsumer2(Consumer<Color> saveConsumer) {
      this.saveConsumer = (integer) -> {
         saveConsumer.accept(this.alpha ? Color.ofTransparent(integer) : Color.ofOpaque(integer));
      };
      return this;
   }
   ...
   public ColorFieldBuilder setSaveConsumer3(Consumer<net.minecraft.util.text.Color> saveConsumer) {
      this.saveConsumer = (integer) -> {
         saveConsumer.accept(net.minecraft.util.text.Color.fromInt(integer));
      };
      return this;
   }
   ...
   public ColorFieldBuilder setDefaultValue2(Supplier<Color> defaultValue) {
      this.defaultValue = () -> {
         return defaultValue.get().getColor();
      };
      return this;
   }
   ...
   public ColorFieldBuilder setDefaultValue(net.minecraft.util.text.Color defaultValue) {
      this.defaultValue = () -> {
         return Objects.requireNonNull(defaultValue).getColor();
      };
      return this;
   }
   ...
   public ColorEntry build() {
      ColorEntry entry = new ColorEntry(this.getFieldNameKey(), this.value, this.getResetButtonKey(), this.defaultValue, this.saveConsumer,
