...
public class DoubleFieldBuilder extends FieldBuilder<Double, DoubleListEntry> {
   ...
   private Function<Double, Optional<ITextComponent[]>> tooltipSupplier = (d) -> {
   ...
   public DoubleListEntry build() {
      DoubleListEntry entry = new DoubleListEntry(this.getFieldNameKey(), this.value, this.getResetButtonKey(), this.defaultValue, this.saveConsumer,
