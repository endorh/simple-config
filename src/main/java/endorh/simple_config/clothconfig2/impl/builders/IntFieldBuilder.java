...
public class IntFieldBuilder
  extends FieldBuilder<Integer, IntegerListEntry> {
	...
	public IntFieldBuilder setErrorSupplier(
	...
	public IntFieldBuilder setTooltipSupplier(
	...
	public IntegerListEntry build() {
		IntegerListEntry entry =
		  new IntegerListEntry(this.getFieldNameKey(), this.value, this.getResetButtonKey(),
