...
public class IntSliderBuilder extends FieldBuilder<Integer, IntegerSliderEntry> {
   ...
   public IntegerSliderEntry build() {
      IntegerSliderEntry entry = new IntegerSliderEntry(this.getFieldNameKey(), this.min, this.max, this.value, this.getResetButtonKey(), this.defaultValue, this.saveConsumer,
