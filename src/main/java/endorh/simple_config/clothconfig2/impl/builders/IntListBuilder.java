...
public class IntListBuilder
  extends FieldBuilder<List<Integer>, IntegerListListEntry> {
	...
	private Function<List<Integer>, Optional<ITextComponent[]>> tooltipSupplier =
	  list -> Optional.empty();
	...
	public IntListBuilder(
	  ITextComponent resetButtonKey, ITextComponent fieldNameKey, List<Integer> value
	) {
	...
	public IntListBuilder setCellErrorSupplier(
	  Function<Integer, Optional<ITextComponent>> cellErrorSupplier
	) {
		this.cellErrorSupplier = cellErrorSupplier;
		return this;
	}
	
	public IntListBuilder setErrorSupplier(
	  Function<List<Integer>, Optional<ITextComponent>> errorSupplier
	) {
	...
	public IntListBuilder setCreateNewInstance(
	  Function<IntegerListListEntry, IntegerListListEntry.IntegerListCell> createNewInstance
	) {
	...
	public IntListBuilder setTooltipSupplier(
	  Function<List<Integer>, Optional<ITextComponent[]>> tooltipSupplier
	) {
	...
	public IntegerListListEntry build() {
		IntegerListListEntry entry =
		  new IntegerListListEntry(this.getFieldNameKey(), this.value, this.expanded, null,
