...
public class FloatListBuilder extends FieldBuilder<List<Float>, FloatListListEntry> {
   ...
   private Function<List<Float>, Optional<ITextComponent[]>> tooltipSupplier = (list) -> {
   ...
   public FloatListListEntry build() {
      FloatListListEntry entry = new FloatListListEntry(this.getFieldNameKey(), this.value, this.expanded,
