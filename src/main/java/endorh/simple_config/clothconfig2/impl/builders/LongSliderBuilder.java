...
public class LongSliderBuilder extends FieldBuilder<Long, LongSliderEntry> {
   ...
   private Function<Long, Optional<ITextComponent[]>> tooltipSupplier = (l) -> {
   ...
   public LongSliderEntry build() {
      LongSliderEntry entry = new LongSliderEntry(this.getFieldNameKey(), this.min, this.max, this.value, this.saveConsumer, this.getResetButtonKey(), this.defaultValue,
