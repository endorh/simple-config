...
public class DoubleListBuilder
  extends FieldBuilder<List<Double>, DoubleListListEntry> {
	...
	private Function<List<Double>, Optional<ITextComponent[]>> tooltipSupplier =
	  list -> Optional.empty();
	...
	public DoubleListBuilder(
	  ITextComponent resetButtonKey, ITextComponent fieldNameKey, List<Double> value
	) {
	...
	public DoubleListBuilder setCellErrorSupplier(
	  Function<Double, Optional<ITextComponent>> cellErrorSupplier
	) {
		this.cellErrorSupplier = cellErrorSupplier;
		return this;
	}
	
	public DoubleListBuilder setErrorSupplier(
	  Function<List<Double>, Optional<ITextComponent>> errorSupplier
	) {
	...
	public DoubleListBuilder setCreateNewInstance(
	  Function<DoubleListListEntry, DoubleListListEntry.DoubleListCell> createNewInstance
	) {
	...
	public DoubleListBuilder setTooltipSupplier(
	  Function<List<Double>, Optional<ITextComponent[]>> tooltipSupplier
	) {
	...
	public DoubleListListEntry build() {
		DoubleListListEntry entry =
		  new DoubleListListEntry(this.getFieldNameKey(), this.value, this.expanded, null,
		                          this.saveConsumer, this.defaultValue, this.getResetButtonKey(),
		                          this.requireRestart, this.deleteButtonEnabled, this.insertInFront);
		if (this.min != null) {
