...
public class LongSliderEntry extends TooltipListEntry<Long> {
   ...
   public LongSliderEntry(ITextComponent fieldName, long minimum, long maximum, long value, Consumer<Long> saveConsumer, ITextComponent resetButtonKey, Supplier<Long> defaultValue, Supplier<Optional<ITextComponent[]>> tooltipSupplier, boolean requiresRestart) {
      ...
      this.textGetter = (valuex) -> {
         return new StringTextComponent(String.format("Value: %d", valuex));
      };
      this.orginial = value;
   ...
   private class Slider extends AbstractSlider {
      ...
      protected void func_230972_a_() {
         LongSliderEntry.this.value.set((long)((double)LongSliderEntry.this.minimum + (double)Math.abs(LongSliderEntry.this.maximum - LongSliderEntry.this.minimum) * this.sliderValue));
      }
      ...
      public boolean mouseDragged(double double_1, double double_2, int int_1, double double_3, double double_4) {
         return !LongSliderEntry.this.isEditable() ? false : super.mouseDragged(double_1, double_2, int_1, double_3, double_4);
      }
