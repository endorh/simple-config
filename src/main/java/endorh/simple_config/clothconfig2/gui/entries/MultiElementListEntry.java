...
public class MultiElementListEntry<T>
  ...
  implements Expandable {
	...
	@ApiStatus.Internal
	public MultiElementListEntry(
	  ITextComponent categoryName, T object, List<AbstractConfigListEntry<?>> entries,
	...
	public Optional<ITextComponent> getError() {
		List<ITextComponent> errors =
		  this.entries.stream().map(AbstractConfigEntry::getConfigError).filter(Optional::isPresent)
