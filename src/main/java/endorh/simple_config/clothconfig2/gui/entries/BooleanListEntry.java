...
public class BooleanListEntry
  extends TooltipListEntry<Boolean> {
	...
	public BooleanListEntry(
	  ITextComponent fieldName, boolean bool, ITextComponent resetButtonKey,
	  Supplier<Boolean> defaultValue, Consumer<Boolean> saveConsumer
	) {
	...
	public BooleanListEntry(
	  ...
	  Supplier<Optional<ITextComponent[]>> tooltipSupplier, boolean requiresRestart
		...
		this.buttonWidget = new Button(0, 0, 150, 20, NarratorChatListener.EMPTY,
		                               widget -> this.bool.set(!this.bool.get()));
		this.resetButton = new Button(0, 0,
		                              ...
		                              widget -> this.bool.set(defaultValue.get()));
	...
	public void render(
	  ...
	  int mouseY, boolean isHovered, float delta
		...
		this.resetButton.active = this.isEditable() && this.getDefaultValue().isPresent() &&
		                          this.defaultValue.get() != this.bool.get();
