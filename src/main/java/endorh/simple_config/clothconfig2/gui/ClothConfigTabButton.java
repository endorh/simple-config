...
public class ClothConfigTabButton extends AbstractButton {
   ...
   public ClothConfigTabButton(ClothConfigScreen screen, int index, int int_1, int int_2, int int_3, int int_4, ITextComponent string_1, Supplier<Optional<ITextProperties[]>> descriptionSupplier) {
   ...
   public void render(MatrixStack matrices, int int_1, int int_2, float float_1) {
      ...
      if (this.isMouseOver(int_1, int_2)) {
         Optional<ITextProperties[]> tooltip = this.getTooltip();
   ...
   public boolean isMouseOver(double double_1, double double_2) {
      return this.visible && double_1 >= (double)this.x && double_2 >= (double)this.y && double_1 < (double)(this.x + this.width) && double_2 < (double)(this.y + this.height) && double_1 >= 20.0D && double_1 < (double)(this.screen.width - 20);
   }
