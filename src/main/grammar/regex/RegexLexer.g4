...
mode CHARACTER_CLASS;
    ...
    ClassMetaCharacter : '\\' [\-\][\\];
    InnerCharacterClassStart : CharacterClassStart -> pushMode(CHARACTER_CLASS);
    InnerNegatedCharacterClassStart : NegatedCharacterClassStart -> pushMode(CHARACTER_CLASS);
    RANGE : '-';
    INTERSECTION : '&&';
