...
public interface TooltipEntryBuilder<V, Gui, Self extends TooltipEntryBuilder<V, Gui, Self>> {
	 ...
	 * @see #withoutTooltip()
	 */
	@Contract(pure=true) @NotNull Self guiTooltip(Function<Gui, List<Component>> tooltipSupplier);
	 ...
	 * @see #withoutTooltip()
	 */
	@Contract(pure=true) @NotNull Self tooltip(Function<V, List<Component>> tooltipSupplier);
	 ...
	 * @see #withoutTooltip()
	 */
	@Contract(pure=true) default @NotNull Self tooltip(Supplier<List<Component>> tooltipSupplier) {
	 ...
	 * @see #withoutTooltip()
	 */
	@Contract(pure=true) default @NotNull Self tooltip(List<Component> tooltip) {
