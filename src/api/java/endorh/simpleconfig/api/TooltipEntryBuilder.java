...
public interface TooltipEntryBuilder<V, Gui, Self extends TooltipEntryBuilder<V, Gui, Self>> {
	 ...
	 * @see #withoutTooltip()
	 */
	@Contract(pure=true) Self guiTooltip(Function<Gui, List<Component>> tooltipSupplier);
	 ...
	 * @see #withoutTooltip()
	 */
	@Contract(pure=true) Self tooltip(Function<V, List<Component>> tooltipSupplier);
	 ...
	 * @see #withoutTooltip()
	 */
	@Contract(pure=true) default Self tooltip(Supplier<List<Component>> tooltipSupplier) {
	 ...
	 * @see #withoutTooltip()
	 */
	@Contract(pure=true) default Self tooltip(List<Component> tooltip) {
