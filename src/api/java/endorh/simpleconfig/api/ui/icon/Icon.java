...
public class Icon {
	...
	public static final Icon EMPTY = new Icon(
	  ...
	  0, 0, 0, 0, 0, 0
		...
		@Override public void renderCentered(PoseStack m, int x, int y, int w, int h, int level) {}
		@Override public void renderStretch(PoseStack m, int x, int y, int w, int h, int level) {}
	 ...
	 */
	@Contract(pure=true) public Icon withTint(ChatFormatting tint) {
	...
	public void renderCentered(PoseStack mStack, Rectangle rect) {
		renderCentered(mStack, rect, 0);
	}
	
	public void renderCentered(
	  PoseStack mStack, int x, int y, int w, int h
	) {
		renderCentered(mStack, x, y, w, h, 0);
	}
	
	public void renderCentered(PoseStack mStack, Rectangle rect, int level) {
		renderCentered(mStack, rect.x, rect.y, rect.width, rect.height, level);
	}
	
	public void renderCentered(
	  PoseStack mStack, int x, int y, int w, int h, int level
	) {
		beforeRender(level);
	...
	public void renderStretch(PoseStack mStack, Rectangle rect) {
	...
	public void renderStretch(PoseStack mStack, Rectangle rect, int level) {
	...
	public void renderFill(PoseStack mStack, Rectangle rect) {
	...
	public void renderFill(PoseStack mStack, Rectangle rect, int level) {
