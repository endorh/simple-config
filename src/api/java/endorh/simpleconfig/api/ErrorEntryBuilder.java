...
public interface ErrorEntryBuilder<V, Config, Gui, Self extends TooltipEntryBuilder<V, Gui, Self>> {
	 ...
	 *                         correct values
	 */
	@Contract(pure=true) @NotNull Self guiError(Function<Gui, Optional<ITextComponent>> guiErrorSupplier);
	 ...
	 */
	@Contract(pure=true) default @NotNull Self guiErrorNullable(Function<Gui, ITextComponent> errorSupplier) {
	 ...
	 *   indicate correct values
	 */
	@Contract(pure=true) default @NotNull Self configErrorNullable(Function<Gui, ITextComponent> errorSupplier) {
		return guiError(v -> Optional.ofNullable(errorSupplier.apply(v)));
	}
	 ...
	 */
	@Contract(pure=true) @NotNull Self error(Function<V, Optional<ITextComponent>> errorSupplier);
	 ...
	 * @param errorSupplier Error message supplier. Empty return values indicate correct values
	 */
	@Contract(pure=true) @NotNull Self configError(Function<Config, Optional<ITextComponent>> errorSupplier);
	 ...
	 *                      correct values
	 */
	@Contract(pure=true) default @NotNull Self errorNullable(Function<V, ITextComponent> errorSupplier) {
