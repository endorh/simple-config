...
public interface ConfigEntryBuilder<V, Config, Gui, Self extends ConfigEntryBuilder<V, Config, Gui, Self>>
  extends TooltipEntryBuilder<V, Gui, Self>,
	...
	@Contract(pure=true)
	@Override Self guiError(Function<Gui, Optional<ITextComponent>> guiErrorSupplier);
	
	@Contract(pure=true)
	@Override Self error(Function<V, Optional<ITextComponent>> errorSupplier);
	
	@Contract(pure=true)
	@Override Self configError(Function<Config, Optional<ITextComponent>> configErrorSupplier);
	
	@Contract(pure=true)
	@Override Self withoutError();
	
	@Contract(pure=true)
	@Override Self guiTooltip(Function<Gui, List<ITextComponent>> tooltipSupplier);
	
	@Contract(pure=true)
	@Override Self tooltip(Function<V, List<ITextComponent>> tooltipSupplier);
