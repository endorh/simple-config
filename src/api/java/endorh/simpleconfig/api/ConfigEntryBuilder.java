...
public interface ConfigEntryBuilder<V, Config, Gui, Self extends ConfigEntryBuilder<V, Config, Gui, Self>>
  extends TooltipEntryBuilder<V, Gui, Self>, ErrorEntryBuilder<V, Config, Gui, Self> {
	...
	@Contract(pure=true)
	@Override @NotNull Self guiError(Function<Gui, Optional<Component>> guiErrorSupplier);
	
	@Contract(pure=true)
	@Override @NotNull Self error(Function<V, Optional<Component>> errorSupplier);
	
	@Contract(pure=true)
	@Override @NotNull Self configError(Function<Config, Optional<Component>> configErrorSupplier);
	
	@Contract(pure=true)
	@Override @NotNull Self withoutError();
	
	@Contract(pure=true)
	@Override @NotNull Self guiTooltip(Function<Gui, List<Component>> tooltipSupplier);
	
	@Contract(pure=true)
	@Override @NotNull Self tooltip(Function<V, List<Component>> tooltipSupplier);
